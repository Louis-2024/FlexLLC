...
PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.fast \
    configs/xyz/simple_ruby.py --wc --ncore 4 --use-ziv --use-vi --l1-assoc 8 --l2-assoc 8 --l3-assoc 8 \
...
# PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.fast \
#     configs/xyz/simple_ruby.py --wc --ncore 4 --wc --use-ziv --use-vi --l1-assoc 8 --l2-assoc 8 --l3-assoc 8 \
...
# PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.fast \
#     configs/xyz/simple_ruby.py --wc --ruby-test --ncore 4 --use-ziv --use-vi --l1-assoc 8 --l2-assoc 8 --l3-assoc 8 \
#     --nreq 20000