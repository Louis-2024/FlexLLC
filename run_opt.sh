...
PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.opt --debug-flags=FlexLLC --debug-file=flexllc.log --debug-start=0 \
    configs/xyz/simple_ruby.py --wc --ncore 4 --l1-assoc 4 --l2-assoc 4 --l3-assoc 4 --l1-size 2kB --l2-size 8kB --l3-size 128kB \
...
# PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.opt --debug-flags=FlexLLC --debug-file=flexllc.log --debug-start=0 \
#     configs/xyz/simple_ruby.py --wc --ncore 4 --wc --l1-assoc 4 --l2-assoc 4 --l3-assoc 4 --l1-size 2kB --l2-size 8kB --l3-size 128kB \
...
# PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.opt --debug-flags=FlexLLC --debug-file=flexllc.log --debug-start=0 \
#     configs/xyz/simple_ruby.py --wc --ruby-test --ncore 4 --l1-assoc 4 --l2-assoc 4 --l3-assoc 4 --l1-size 2kB --l2-size 8kB --l3-size 128kB \
#     --nreq 20000